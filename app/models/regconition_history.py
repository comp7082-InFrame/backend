import uuid
from sqlalchemy import Column, Double, Boolean, ForeignKey, TIMESTAMP, Text, func
...
class RecognitionHistory(Base):
    ...
    attendance_session_id = Column(UUID(as_uuid=True), ForeignKey("attendance_session.id", ondelete="CASCADE"), nullable=False)
